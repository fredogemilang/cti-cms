...
Route::get('/category', fn () => redirect(trailing_slash_url(url('/blog-news')), 301));
Route::get('/tag', fn () => redirect(trailing_slash_url(url('/blog-news')), 301));
Route::get('/blog', fn () => redirect(trailing_slash_url(url('/blog-news')), 301));
Route::get('/insight', fn () => redirect(trailing_slash_url(url('/blog-news')), 301));
Route::get('/insights', fn () => redirect(trailing_slash_url(url('/blog-news')), 301));
Route::get('/articles', fn () => redirect(trailing_slash_url(url('/blog-news')), 301));
Route::get('/landing', fn () => redirect(trailing_slash_url(url('/')), 301));
Route::get('/videos', fn () => redirect(trailing_slash_url(url('/video')), 301));
Route::get('/about-us/management', fn () => redirect(trailing_slash_url(url('/about-management')), 301));
Route::get('/nebula', fn () => redirect(trailing_slash_url(url('/nebula-cloud-console')), 301));
...
Route::get('/industry', fn () => redirect(trailing_slash_url(url('/industry/ecommerce')), 301));
Route::get('/technology-alliance', fn () => redirect(trailing_slash_url(url('/amazon-web-services')), 301));
Route::get('/contact', fn () => redirect(trailing_slash_url(url('/contact-us')), 301));
Route::get('/career', fn () => redirect(trailing_slash_url(url('/careers')), 301));
Route::get('/terms-of-use', fn () => redirect(trailing_slash_url(url('/privacy-policy')), 301));
