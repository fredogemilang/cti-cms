      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24 pl-0 lg:pl-12">
        ...
        <div>
          ...
          <div class="flex gap-4 text-sm mb-6 text-white/90">
            ...
            <p class="leading-relaxed">Centennial Tower, 12th Floor Jl. Jend. Gatot<br>Subroto Kav. 24-25, Jakarta, Indonesia</p>
          </div>
          ...
          <div class="flex gap-4 text-sm mb-6 items-center text-white/90">
            ...
            <p>{!! safe_phone(setting('site_phone', '(+62 21) 80622200'), 'hover:text-white transition') !!}</p>
          </div>
          ...
          <div class="flex gap-4 text-sm items-center text-white/90">
            ...
            <p>{!! safe_email(setting('site_email', 'marketing@centraldatatech.com'), 'hover:text-white transition') !!}</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="flex gap-3 mb-6">
            <!-- LinkedIn -->
            <a href="{{ setting('social_linkedin', 'https://www.linkedin.com/company/central-data-technology-pt-/') }}" title="LinkedIn Central Data Technology" aria-label="LinkedIn" target="_blank" rel="noopener" class="w-8 h-8 bg-white text-zinc-900 rounded-full flex items-center justify-center hover:bg-zinc-200 transition">
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
            </a>
            <!-- Facebook -->
            <a href="{{ setting('social_facebook', 'https://www.facebook.com/centraldatatech') }}" title="Facebook Central Data Technology" aria-label="Facebook" target="_blank" rel="noopener" class="w-8 h-8 bg-white text-zinc-900 rounded-full flex items-center justify-center hover:bg-zinc-200 transition">
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
            </a>
            <!-- Instagram -->
            <a href="{{ setting('social_instagram', 'https://www.instagram.com/centraldataid/') }}" title="Instagram Central Data Technology" aria-label="Instagram" target="_blank" rel="noopener" class="w-8 h-8 bg-white text-zinc-900 rounded-full flex items-center justify-center hover:bg-zinc-200 transition">
            ...
            <!-- Twitter/X -->
            <a href="{{ setting('social_twitter', 'https://twitter.com/centraldataID') }}" title="Twitter Central Data Technology" aria-label="Twitter" target="_blank" rel="noopener" class="w-8 h-8 bg-white text-zinc-900 rounded-full flex items-center justify-center hover:bg-zinc-200 transition">
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/></svg>
            </a>
            <!-- YouTube -->
            <a href="{{ setting('social_youtube', 'https://www.youtube.com/channel/UCG0E2Kc-QvMRLJ70Q-XeemA/featured') }}" title="YouTube Central Data Technology" aria-label="YouTube" target="_blank" rel="noopener" class="w-8 h-8 bg-white text-zinc-900 rounded-full flex items-center justify-center hover:bg-zinc-200 transition">
