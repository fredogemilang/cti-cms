...
<div class="lg:hidden bg-white border-b border-zinc-100 sticky top-0 z-[100]">
  <div class="flex items-center justify-between px-4 py-3">
    ...
    <a href="{{ localized_url('/') }}" title="Central Data Technology - Home" aria-label="Home" class="flex-shrink-0">
      <img src="{{ $siteLogoUrl }}" alt="{{ setting('site_name', 'Central Data Technology') }}" title="{{ setting('site_name', 'Central Data Technology') }}" width="83" height="48" class="h-12 w-auto object-contain">
    </a>
...
>
  ...
  <div class="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
    <nav class="flex items-center justify-between h-20">
      <!-- Logo -->
      <a href="{{ localized_url('/') }}" title="Central Data Technology - Home" aria-label="Home" class="flex-shrink-0">
        <img src="{{ $siteLogoUrl }}" alt="{{ setting('site_name', 'Central Data Technology') }}" title="{{ setting('site_name', 'Central Data Technology') }}" width="111" height="64" class="h-16 w-auto object-contain">
      </a>
