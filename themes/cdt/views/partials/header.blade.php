  ...
  <div class="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
    <nav class="flex items-center justify-between h-20">
      ...
      <ul class="hidden lg:flex items-center gap-6 text-[13px] font-bold text-zinc-800 uppercase tracking-wide h-full">
              ...
              <div
                ...
                <div>
                  ...
                  <p
                    ...
                    Explore our comprehensive ecosystem of global technology partners designed to empower your
                ...
                <div class="grid grid-cols-2 gap-y-2 gap-x-6">
                  ...
                  @empty
                    <a href="{{ url('/technology-alliance') }}"
                      class="text-sm font-semibold text-gray-700 hover:text-primary border-b border-gray-200 py-2.5 px-3">All Technology Partners →</a>
                  @endforelse
                </div>
              </div>
            </div>
        ...
        <!-- Contact Us -->
        <li>
          <a href="{{ url('/contact') }}" class="hover:text-primary transition duration-300">Contact Us</a>
        </li>
      </ul>
