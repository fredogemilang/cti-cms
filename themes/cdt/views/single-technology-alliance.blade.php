    ...
    <div class="flex flex-col lg:flex-row gap-12 lg:gap-20">
      <div class="w-full lg:w-1/2 flex flex-col justify-center">
        ...
        @php
          ...
          $allianceName = $entry->getTranslation('title', $currentLocale) ?: $entry->title;
          $allianceSlug = $entry->slug;
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col lg:flex-row border border-zinc-100 min-h-[400px]">
              ...
              <div class="lg:w-2/3 p-10 md:p-12 flex items-center relative">
                ...
                <div class="relative z-10 w-full">
                  <div class="text-base md:text-lg text-zinc-900 font-light leading-relaxed space-y-4 [&_p]:mb-4 last:[&_p]:mb-0">{!! $storyContent !!}</div>
                </div>
              </div>
            </div>
          </div>
