            ...
            <a data-gsap="fade-up" data-gsap-delay="{{ $loop->index * 0.1 }}" href="{{ $rel->getUrl() }}" class="group bg-white hover:bg-red-50/30 rounded-3xl p-8 border border-zinc-200/80 shadow-sm hover:shadow-xl hover:border-primary/50 transition-all flex flex-col justify-between">
              <div>
                ...
                @php
                  ...
                  $relTitle = $rel->getTranslation('title', $relLocale, false) ?: $rel->title;
                ...
                @endphp
                <h3 class="text-xl font-bold text-zinc-900 mb-3 group-hover:text-primary transition-colors">{{ $relTitle }}</h3>
      ...
      <div class="w-full lg:w-1/2 flex flex-col justify-center">
        ...
        <div class="space-y-8 mt-12">
          ...
          <div class="flex items-start gap-5" data-gsap="fade-up" data-gsap-delay="0.2">
            ...
            <div><h3 class="text-lg font-bold text-zinc-900">{{ t('alliance.professional_it_expert_title', 'Professional IT Expert') }}</h3><p class="text-base text-zinc-500">{{ t('alliance.professional_it_expert_desc', 'By providing IT experts, we have secured CDT\'s presence in a variety of industries.') }}</p></div>
          </div>
