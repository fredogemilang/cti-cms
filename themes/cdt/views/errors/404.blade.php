...
<head>
    ...
    <title>{{ t('errors.404_title', '404 - Page Not Found') }} | {{ setting('site_name', 'Central Data Technology') }}</title>
        ...
        <div class="max-w-xl mx-auto text-center">
            ...
            <div class="relative inline-flex items-center justify-center mb-8">
                ...
                <div class="relative w-28 h-28 sm:w-32 sm:h-32 rounded-3xl bg-gradient-to-b from-white to-red-50/50 border border-red-100 shadow-xl shadow-red-950/5 flex items-center justify-center flex-col gap-1">
                    <span class="text-4xl sm:text-5xl font-extrabold font-heading text-[#e30613] tracking-tight">404</span>
                    <span class="text-[10px] font-bold uppercase tracking-widest text-zinc-400">Error</span>
                </div>
            </div>
            ...
            <p class="text-zinc-600 text-base sm:text-lg leading-relaxed mb-8 max-w-md mx-auto">
                {{ t('errors.404_message', 'The page you are looking for might have been moved, renamed, or is temporarily offline.') }}
            </p>
