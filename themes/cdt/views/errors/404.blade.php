...
<head>
    ...
    <style>
        ...
        .btn-theme-primary:hover {
            background-color: var(--color-primary-hover, #c00510);
        }
        .badge-theme {
            background-color: color-mix(in srgb, var(--color-primary, #e30613) 10%, transparent);
            color: var(--color-primary, #e30613);
            border-color: color-mix(in srgb, var(--color-primary, #e30613) 25%, transparent);
        }
    </style>
</head>
