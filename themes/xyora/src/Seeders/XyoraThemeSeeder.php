...
namespace Themes\Xyora\Seeders;
...
class XyoraThemeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $productCategoryTax = CustomTaxonomy::updateOrCreate(
        ...
        foreach ($categoriesData as $cat) {
            $terms[$cat['slug']] = TaxonomyTerm::updateOrCreate(
                [
        ...
        foreach ($pagesData as $p) {
            ...
            app(PageTemplateService::class)->seedBlocks($page);
        }
        ...
        if (Schema::hasTable('posts')) {
            ...
            if (Schema::hasTable('settings')) {
                Setting::set('permalink_post_base', 'blog', 'general', 'text');
            }
        }
