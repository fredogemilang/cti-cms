...
@section('content')
  @php
    ...
    $contactImageUrl = resolve_block_asset($contactImage);
    ...
    $rmaImageUrl = resolve_block_asset($rmaImage);
    ...
    $statusImageUrl = resolve_block_asset($statusImage);
  @endphp
      ...
      <div class="kontak-container-custom">
        ...
        <div class="kontak-info">
          ...
          <div class="kontak-image-wrapper">
            <img src="{{ $contactImageUrl }}" alt="Hubungi Xyora" />
          </div>
        </div>
      ...
      <div class="rma-container-custom">
        ...
        <div class="rma-info">
          ...
          <div class="rma-image-wrapper">
            <img src="{{ $rmaImageUrl }}" alt="Ajukan RMA Xyora" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="status-section-custom" id="status-rma">
      <div class="status-container-custom">
        ...
        <div class="status-image-wrapper">
          <img src="{{ $statusImageUrl }}" alt="Cek Status RMA Xyora" />
        </div>
      </div>
    </section>
  </main>
