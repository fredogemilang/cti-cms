    ...
    <x-admin.ui.table>
        <x-slot:thead>
            <x-admin.ui.table-header class="px-8 w-10">
                <input type="checkbox" wire:model.live="selectAll" class="h-4 w-4 rounded accent-[#2563EB]" />
            </x-admin.ui.table-header>
            <x-admin.ui.table-header sortBy="title" :field="$sortField" :direction="$sortDirection">
                Title
            </x-admin.ui.table-header>
            <x-admin.ui.table-header>Author</x-admin.ui.table-header>
            <x-admin.ui.table-header sortBy="status" :field="$sortField" :direction="$sortDirection">
                Status
            </x-admin.ui.table-header>
            <x-admin.ui.table-header sortBy="updated_at" :field="$sortField" :direction="$sortDirection">
                Last Modified
            </x-admin.ui.table-header>
            ...
            <tr>
                <td colspan="6" class="px-8 py-16 text-center">
                    <div class="flex flex-col items-center">
                        <div class="h-16 w-16 rounded-2xl bg-gray-100 dark:bg-[#272B30] flex items-center justify-center mb-4">
                        ...
                        <a href="{{ route('admin.pages.create') }}"
                            class="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold text-[#2563EB] hover:underline">
