                    ...
                    <div class="space-y-10">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-5">
                                ...
                                {{-- Site Logo & Favicon — managed in General Settings --}}
                                <div class="p-4 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p class="text-xs font-bold text-[#111827] dark:text-[#FCFCFC]">Logo & Favicon</p>
                                            <p class="text-[11px] text-[#6F767E] mt-1">Site Logo and Favicon are managed in <a href="{{ route('admin.settings.show', 'general') }}" class="text-blue-600 dark:text-blue-400 font-bold hover:underline">General Settings → Site Identity</a>.</p>
                                        </div>
                                    </div>
                                </div>
