...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        foreach ([\App\Models\Page::class, \App\Models\CptEntry::class] as $contentModel) {
            $contentModel::saved(fn () => \App\Http\Middleware\PageCache::purgeAll());
    ...
    {
        $registry = $this->app->make(\App\Services\SettingsRegistry::class);
        ...
        $registry->registerGroup('brevo', [
            ...
            'actions' => [
                ['label' => 'Send test email to me', 'handler' => \App\Settings\Actions\BrevoTestEmailAction::class, 'icon' => 'send', 'color' => 'blue'],
            ],
        ]);
